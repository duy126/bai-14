...
const ShoesStore = () => {
  ...
  const [listItem,getListItem] = useState(
    [
      {
        "id": 1,
  ...
  return <div>
     <Modal setNumber={setNumber} number={number} listItem={listItem} getListItem={getListItem}></Modal>
    <ProductList  listItem={listItem}></ProductList>
